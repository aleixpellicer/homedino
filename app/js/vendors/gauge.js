...
(function() {
  ...
  BaseDonut = (function(_super) {
    ...
    BaseDonut.prototype.percentColors = null;
  ...
  Donut = (function(_super) {
    ...
    Donut.prototype.configPercentColors = function() {
      var bval, gval, i, rval, _i, _ref, _results;
      this.percentColors = null;
    ...
    Donut.prototype.getColorForPercentage = function(pct) {
      if(this.percentColors){
        var color, endColor, i, rangePct, startColor, _i, _ref;
        if (pct === 0) {
          color = this.percentColors[0].color; 
        } else {
    ...
    Donut.prototype.getColorForValue = function(val) {
      var pct;
      pct = (val - this.minValue) / (this.maxValue - this.minValue);
    ...
    Donut.prototype.render = function() {
      ...
      this.ctx.stroke();
      this.ctx.strokeStyle = this.getColorForValue(this.displayedValue);
      this.ctx.beginPath();
      this.ctx.arc(w, h, this.radius, (1 - this.options.angle) * Math.PI, displayedAngle, false);
